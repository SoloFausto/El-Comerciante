...
<head>
    ...
    <link rel="stylesheet" href="estiloHelado.css">
...
<body>
    ...
    <div class="page">
        <div class="content">
            ...
            <div class="statP"><a href="tabletaProducto.php" class="statP"><img src="resources/SVGCAFE.png" class="icons" alt="icono de cafe">Productos</a></div>
        </div>
    </div>
    </div>
    <div class="bigtable table-responsive">
            <?php 
                include("tabletaListarHelado.php");
            ?>
</div>
    <div class="floor">
        <div class="carrito">
