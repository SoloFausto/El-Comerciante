...
function modificarenvase(){
    ...
    <form action="">
        ...
        <input type="number" min="1" placeholder="Precio:">    <br>
        <input type="number" min="1" placeholder="Cantidad de sabores:">	    <br>
  ...
  function removeModificarEnvase(){
    $(".popupHelado").remove();
  }