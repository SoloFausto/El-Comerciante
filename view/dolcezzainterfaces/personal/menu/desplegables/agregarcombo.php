      ...
      <hr>
        <div class="agregarComboDiv">
          <div style=" margin-left: 50px; display: flex; flex-direction: column; gap: 10px; ">
            <input type="text" name="nombreCombo" id="nombreCombo" placeholder="Nombre de el combo" style="width: 50vh; height: 5vh;">
            <input type="text" name="descripcionCombo" id="descripcionCombo" placeholder="Descripcion de el combo" style="height:30vh;">
            <div>
