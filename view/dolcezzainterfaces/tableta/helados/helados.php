...
<body>
    ...
    <div class="page">
        <div class="content">
            ...
            <div class="statP"><a href="../Producto/producto.php" class="statP">
                <svg xmlns="http://www.w3.org/2000/svg" width="28" height="28" fill="currentColor" class="bi bi-cup-hot" viewBox="0 0 16 16">
    ...
    <div class="floor">
        <div class="carrito">
            ...
            <button type="submit" class="botoncito">
