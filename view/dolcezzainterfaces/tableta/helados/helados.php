...
<body>
    ...
    <div class="page">
        <div class="content">
            ...
            <div class="statP"><a href="../Producto/producto.php" class="statP"><img class="icons" src="https://cdn-icons-png.flaticon.com/512/2234/2234937.png" alt="Paleta de Helado">Productos</a></div>
        </div>
    </div>
    </div>
